...
@section('content')
    ...
    <a href="{{ route('attendances.create') }}" class="btn btn-primary mb-3">Ajouter une Présence de votre Heure d'Arrivée</a>
            ...
            @forelse($attendances as $attendance)
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{{ route('attendances.edit', $attendance->id) }}" class="btn btn-warning btn-sm">Modifier en cas de votre heure de depart</a>
